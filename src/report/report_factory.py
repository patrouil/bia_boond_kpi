...
from report.contrat_resource_suivi_engine_details import ContratResourceSuiviEngineDetails
...
class ReportFactory :
    ...
    def reportOf(self,  api: BoondApi, definition: ReportDefinition)-> GenericReport:
        ...
        if ( definition.name == self.SUIVI_RESOURCE_ACTION) : return ContratResourceSuiviEngineDetails(api, definition)
