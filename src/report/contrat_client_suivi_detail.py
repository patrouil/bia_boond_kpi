...
class ContratClientSuiviDetail(GenericReport):
    SUIVI_PER_SLIDE = 10
    ...
    def write_suivi_slide(self, suivi_list: [MaturiteContrat], prs: Presentation) -> None:
        ...
        slide.shapes.title.text = 'Actions Client sur les Missions'
        ...
        table.cell(0, 1).text = 'Client/Consultant'
        table.cell(0, 2).text = 'Action'
        table.cell(0, 3).text = 'Détail Action'
